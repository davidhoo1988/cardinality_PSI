...
namespace NN {
    ...
    public:
        ...
        // user defined
        CiphertextCRT CipherAddCRT(const CiphertextCRT& input1, const CiphertextCRT& input2, fbscrypto::SKIP_STEP step = fbscrypto::SKIP_STEP::KEYSWITCH);
        std::vector<int64_t> ErrorCRT(const CiphertextCRT& value, fbscrypto::CIPHERTEXT_STATE from = fbscrypto::CIPHERTEXT_STATE::TRIVIAL_BEFORE_KEYSWITCH);
